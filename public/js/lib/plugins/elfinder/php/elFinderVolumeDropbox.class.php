...
class elFinderVolumeDropbox extends elFinderVolumeDriver {
	...
	**/
	...
	public function __construct() {
		...
		@ include '../../../../../plugins/elfinder/php/Dropbox/autoload.php';
		...
		if ($options['user'] === 'init') {
			...
			if (class_exists('OAuth')) {
				...
				if (! class_exists('HTTP_OAuth_Consumer')) {
					...
					include '../../../../../plugins/elfinder/php/HTTP/OAuth/Consumer.php';
				}
				if (class_exists('HTTP_OAuth_Consumer')) {
	...
	**/
	...
	private function getHttpResponseHeader($url) {
		if (function_exists('curl_exec')) {
			...
			require_once '../../../../../plugins/elfinder/php/HTTP/Request2.php';
			try {
